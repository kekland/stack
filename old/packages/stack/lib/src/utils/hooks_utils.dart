...
TProxy useValueProxy<TProxy extends ValueProxy<TData>, TData>(TData data) {
  final dispatcher = di.i.dispatcherFor<TData>();
  final proxy = useDisposable(() => dispatcher.createProxy(data), [dispatcher.identify(data)]);
